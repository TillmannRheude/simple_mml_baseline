...
batch_size=16
modelname_optimizer_lr=0.00021172460631364208
modelname_optimizer_warmup_steps=100
modelname_optimizer_weight_decay=0.1
modelname_mmp_attn_steps_dropout=0.2
modelname_mmp_attn_steps_nhead=8
modelname_mmp_loss_alignment_alpha=0.018496890765955523
modelname_mmp_num_aggregated_tokens=8
modelname_mmp_proj_mlp_dropout=0
