...
# modelname.optimizer.lr=0.0005265087256530262 modelname.optimizer.warmup_steps=200 modelname.optimizer.weight_decay=0.001 modelname.dgl.unimodal_loss_weight=0.8882835227560955

modelname_optimizer_lr=0.0005265087256530262
modelname_optimizer_warmup_steps=200
modelname_optimizer_weight_decay=0.001
modelname_dgl_unimodal_loss_weight=0.8882835227560955
