...
#SBATCH --job-name=SB-CV-SimBaMM-Missing
#SBATCH -p gpu
#SBATCH --gres=gpu:1
#SBATCH --mem=200G
...
batch_size=16
modelname_optimizer_lr=7.745111581593284e-06
modelname_optimizer_warmup_steps=200
modelname_optimizer_weight_decay=0.1
modelname_pipeline_full_seq=False
...
python3 /sc-projects/sc-proj-ukb-cvd/projects/simple_mml_baseline_tr/main_incltest.py split_nr=${split_nr} \
        ...
        wandb.group="CV-CHSims-SimBaMM-Missing" \
