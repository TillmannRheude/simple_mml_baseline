...
#SBATCH --job-name=SB-CV-SB-Missing
#SBATCH -p gpu
#SBATCH --gres=gpu:1
#SBATCH --mem=200G
...
# modelname.optimizer.lr=4.05424714581332e-05 modelname.optimizer.warmup_steps=1000 modelname.optimizer.weight_decay=0

modelname_optimizer_lr=4.05424714581332e-05
...
python3 /sc-projects/sc-proj-ukb-cvd/projects/simple_mml_baseline_tr/main_incltest.py split_nr=${split_nr} \
        ...
        wandb.group="CV-CHSims2-SimBaMM-Missing" \
