...
modelname_optimizer_lr=2.115379227633097e-05
modelname_optimizer_warmup_steps=500
modelname_optimizer_weight_decay=0.0
modelname_shaspec_loss_alpha=0.019832042674637475
modelname_shaspec_loss_beta=0.0016412101034477702
...
python3 /sc-projects/sc-proj-ukb-cvd/projects/simple_mml_baseline_tr/main_incltest.py split_nr=${split_nr} \
        ...
        encoders="mimic_haim" \
        modelname=shaspec \
        wandb.group="CV-Haim-ShaSpec-New" \
