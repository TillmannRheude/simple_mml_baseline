...
# modelname.ogm.alpha=0.6421402282179391 modelname.ogm.use_ge=True modelname.optimizer.lr=0.05324130546643632 modelname.optimizer.warmup_steps=100 modelname.optimizer.weight_decay=0.1

modelname_optimizer_lr=0.05324130546643632
modelname_optimizer_warmup_steps=100
modelname_optimizer_weight_decay=0.1
modelname_ogm_alpha=0.6421402282179391
