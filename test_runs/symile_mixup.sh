...
modelname_optimizer_lr=0.00034858588765377063 
modelname_optimizer_warmup_steps=100
modelname_optimizer_weight_decay=0.001

modelname_mixup_consistency_loss_weights='[0.5,0.5,0.5]'
modelname_mixup_mixup_alpha=0.1
modelname_mixup_modalities_to_mix='[0,2]'
modelname_mixup_unimodal_loss_weights='[1,1,1]'
...
python3 /sc-projects/sc-proj-ukb-cvd/projects/simple_mml_baseline_tr/main_incltest.py split_nr=${split_nr} \
        ...
        modelname.mixup.consistency_loss_weights=${modelname_mixup_consistency_loss_weights} \
        modelname.mixup.mixup_alpha=${modelname_mixup_mixup_alpha} \
        modelname.mixup.modalities_to_mix=${modelname_mixup_modalities_to_mix} \
        modelname.mixup.unimodal_loss_weights=${modelname_mixup_unimodal_loss_weights} \
