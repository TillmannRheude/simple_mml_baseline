...
batch_size=128
modelname_optimizer_lr=0.00032551624244926507
...
modelname_crossmodal_transformer_dropout=0
modelname_crossmodal_transformer_nhead=1
modelname_crossmodal_transformer_num_layers=8

python3 /sc-projects/sc-proj-ukb-cvd/projects/simple_mml_baseline_tr/main_incltest.py split_nr=${split_nr} \
        dataset="mosei" \
        encoders="mosei" \
        modelname=mult \
        wandb.group="CV-MOSEI-MulT" \
