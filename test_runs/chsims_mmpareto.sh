...
batch_size=16
modelname_optimizer_lr=7.189767290873701e-06
modelname_optimizer_warmup_steps=200
modelname_optimizer_weight_decay=0.0
modelname_mmpareto_gamma=0.7200645183186295
modelname_mmpareto_unimodal_loss_weight=0.7336936849636138

python3 /sc-projects/sc-proj-ukb-cvd/projects/simple_mml_baseline_tr/main_incltest.py split_nr=${split_nr} \
        dataset="ch_sims" \
        encoders="ch_sims" \
        modelname=mmpareto \
        wandb.group="CV-CHSims-MMPareto" \
