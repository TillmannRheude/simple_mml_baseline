...
modelname_mcr_contrastive_temp=0.958118989807528
modelname_mcr_loss_weights_ceb=0.1573723627113847
modelname_mcr_loss_weights_con=0.4239020348526056
modelname_mcr_loss_weights_mipd=0.8888787309500072
modelname_mcr_loss_weights_uni="[0.3,0.3,0.3]"
modelname_mcr_num_permutations=2
modelname_mcr_strategy=Greedy
modelname_optimizer_lr=0.002613672775718528
