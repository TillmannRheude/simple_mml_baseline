...
modelname_optimizer_lr=6.095096914683594e-05
modelname_optimizer_warmup_steps=100
modelname_optimizer_weight_decay=0.001

modelname_mmpareto_gamma=0.05604308130793465
modelname_mmpareto_unimodal_loss_weight=0.023334903518151557

python3 /sc-projects/sc-proj-ukb-cvd/projects/simple_mml_baseline_tr/main_incltest.py split_nr=${split_nr} \
        dataset="mimic_haim" \
        encoders="mimic_haim" \
        modelname=mmpareto \
        wandb.group="CV-Haim-MMPareto" \
