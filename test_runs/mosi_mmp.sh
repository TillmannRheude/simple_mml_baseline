...
modelname_optimizer_lr=0.0228861447510976
modelname_optimizer_warmup_steps=500
modelname_optimizer_weight_decay=0.0

modelname_mmp_attn_steps_dropout=0.1
modelname_mmp_attn_steps_nhead=8
modelname_mmp_loss_alignment_alpha=0.01855604086154014
modelname_mmp_num_aggregated_tokens=16
modelname_mmp_proj_mlp_dropout=0.2
