...
#  modelname.optimizer.lr=1.6251897729268623e-05 modelname.optimizer.warmup_steps=100 modelname.optimizer.weight_decay=0.1 modelname.shaspec.loss_alpha=0.8349663161297083 modelname.shaspec.loss_beta=0.061250476413275974


modelname_optimizer_lr=1.6251897729268623e-05
modelname_optimizer_warmup_steps=100
modelname_optimizer_weight_decay=0.1
modelname_shaspec_loss_alpha=0.8349663161297083
modelname_shaspec_loss_beta=0.061250476413275974
...
python3 /sc-projects/sc-proj-ukb-cvd/projects/simple_mml_baseline_tr/main_incltest.py split_nr=${split_nr} \
        ...
        encoders="ch_sims_v2" \
        modelname=shaspec \
        wandb.group="CV-CHSims2-ShaSpec" \
        ...
        modelname.shaspec.loss_alpha=${modelname_shaspec_loss_alpha} \
        modelname.shaspec.loss_beta=${modelname_shaspec_loss_beta}