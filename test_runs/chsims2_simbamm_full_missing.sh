...
#SBATCH --job-name=SB-CV-SBFull-Missing
#SBATCH -p gpu
#SBATCH --gres=gpu:1
#SBATCH --mem=200G
...
# modelname.optimizer.lr=0.00012173997635621951 modelname.optimizer.warmup_steps=200 modelname.optimizer.weight_decay=0.1 modelname.pipeline.full_seq=True

modelname_optimizer_lr=0.00012173997635621951
...
python3 /sc-projects/sc-proj-ukb-cvd/projects/simple_mml_baseline_tr/main_incltest.py split_nr=${split_nr} \
        ...
        wandb.group="CV-CHSims2-SimBaMM-Full-Missing" \
