...
batch_size=128
# modelname.dgl.unimodal_loss_weight=0.28049647002656874
modelname_optimizer_lr=0.0001149668249921314
modelname_optimizer_warmup_steps=1000
modelname_optimizer_weight_decay=0.01
modelname_dgl_unimodal_loss_weight=0.28049647002656874
...
python3 /sc-projects/sc-proj-ukb-cvd/projects/simple_mml_baseline_tr/main_incltest.py split_nr=${split_nr} \
        ...
        encoders="mosi" \
        modelname=dgl \
        wandb.group="CV-MOSI-SimBaMM-DGL" \
