...
batch_size=128
# modelname.omib.beta=0.002117638896568442 modelname.omib.cross_attn_network.dim_feedforward=128 modelname.omib.cross_attn_network.dropout=0 modelname.omib.cross_attn_network.num_heads=8 modelname.omib.cross_attn_network.num_layers=16 modelname.omib.warmup_epochs=0 modelname.optimizer.lr=0.001519005422739679 modelname.optimizer.warmup_steps=0 modelname.optimizer.weight_decay=0.1
modelname_omib_beta=0.002117638896568442
modelname_omib_cross_attn_network_dim_feedforward=128
modelname_omib_cross_attn_network_dropout=0
modelname_omib_cross_attn_network_num_heads=8
modelname_omib_cross_attn_network_num_layers=16
modelname_omib_warmup_epochs=0
modelname_optimizer_lr=0.001519005422739679
