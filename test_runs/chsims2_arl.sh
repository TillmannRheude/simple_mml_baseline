...
# modelname.optimizer.lr=7.162455768741684e-06 modelname.optimizer.warmup_steps=1000 modelname.optimizer.weight_decay=0.1 modelname.arl.temperature=0.04774879069677702 modelname.arl.unimodal_loss_weight=0.045015018458108534

modelname_optimizer_lr=7.162455768741684e-06
modelname_optimizer_warmup_steps=1000
modelname_optimizer_weight_decay=0.1
modelname_arl_temperature=0.04774879069677702
modelname_arl_unimodal_loss_weight=0.045015018458108534
...
python3 /sc-projects/sc-proj-ukb-cvd/projects/simple_mml_baseline_tr/main_incltest.py split_nr=${split_nr} \
        ...
        modelname.arl.temperature=${modelname_arl_temperature} \
        modelname.arl.unimodal_loss_weight=${modelname_arl_unimodal_loss_weight}