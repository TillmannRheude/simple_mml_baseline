...
# modelname.ogm.alpha=0.07015080890651154 modelname.ogm.use_ge=False modelname.optimizer.lr=0.02789896264670275 modelname.optimizer.warmup_steps=0 modelname.optimizer.weight_decay=0.1

modelname_optimizer_lr=0.02789896264670275
modelname_optimizer_warmup_steps=0
modelname_optimizer_weight_decay=0.1
modelname_ogm_alpha=0.07015080890651154
