...
modelname_simmlm_gating_hidden_dim=1024
modelname_simmlm_mofe_lambda=1.7495804730783134e-06
modelname_optimizer_lr=0.0008241477174719474
...
python3 /sc-projects/sc-proj-ukb-cvd/projects/simple_mml_baseline_tr/main_incltest.py split_nr=${split_nr} \
        ...
        modelname.simmlm.gating_hidden_dim=${modelname_simmlm_gating_hidden_dim} \
        modelname.simmlm.mofe_lambda=${modelname_simmlm_mofe_lambda}