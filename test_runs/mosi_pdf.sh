...
batch_size=128
modelname_optimizer_lr=0.013696522221801904
modelname_optimizer_warmup_steps=1000
modelname_optimizer_weight_decay=0
modelname_pdf_loss_weight=0.4614771252494547
modelname_pdf_p_head_dropout=0.1
modelname_pdf_p_head_hidden_dims="[512]"
modelname_pdf_unimodal_loss_weight=0.7949264440841395
