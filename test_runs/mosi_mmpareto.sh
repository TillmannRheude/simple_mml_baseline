...
batch_size=128
modelname_optimizer_lr=0.0017828912913044838
modelname_optimizer_warmup_steps=100
modelname_optimizer_weight_decay=0
modelname_mmpareto_gamma=0.17961228960808162
modelname_mmpareto_unimodal_loss_weight=0.02029415620136095
...
python3 /sc-projects/sc-proj-ukb-cvd/projects/simple_mml_baseline_tr/main_incltest.py split_nr=${split_nr} \
        ...
        encoders="mosi" \
        modelname=mmpareto \
        wandb.group="CV-MOSI-SimBaMM-MMPareto" \
