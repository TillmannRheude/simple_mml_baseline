...
# modelname.low_rank_matrix_fusion.rank=10 modelname.optimizer.lr=6.967881368820113e-05 modelname.optimizer.warmup_steps=100 modelname.optimizer.weight_decay=0

modelname_optimizer_lr=6.967881368820113e-05
modelname_optimizer_warmup_steps=100
modelname_optimizer_weight_decay=0.0
modelname_low_rank_matrix_fusion_rank=10
