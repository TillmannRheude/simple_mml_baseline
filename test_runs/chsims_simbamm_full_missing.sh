...
#SBATCH --job-name=SB-CV-SimBaMM-Full-Missing
#SBATCH -p gpu
...
batch_size=16
# modelname.optimizer.lr=9.428197977875136e-05 modelname.optimizer.warmup_steps=200 modelname.optimizer.weight_decay=0 modelname.pipeline.full_seq=True
modelname_optimizer_lr=9.428197977875136e-05
...
python3 /sc-projects/sc-proj-ukb-cvd/projects/simple_mml_baseline_tr/main_incltest.py split_nr=${split_nr} \
        ...
        wandb.group="CV-CHSims-SimBaMM-Full-Missing" \
