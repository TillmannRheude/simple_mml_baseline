...
#SBATCH --job-name=SB-CV-MMPareto
#SBATCH -p gpu
#SBATCH --gres=gpu:1
#SBATCH --mem=200G
...
# modelname.mmpareto.gamma=0.6750122459363094 modelname.mmpareto.unimodal_loss_weight=0.02132081969194942 modelname.optimizer.lr=5.123664212513269e-05 modelname.optimizer.warmup_steps=100 modelname.optimizer.weight_decay=0

modelname_optimizer_lr=5.123664212513269e-05
modelname_optimizer_warmup_steps=100
modelname_optimizer_weight_decay=0
modelname_mmpareto_gamma=0.6750122459363094
modelname_mmpareto_unimodal_loss_weight=0.02132081969194942
...
python3 /sc-projects/sc-proj-ukb-cvd/projects/simple_mml_baseline_tr/main_incltest.py split_nr=${split_nr} \
        ...
        encoders="ch_sims_v2" \
        modelname=mmpareto \
        wandb.group="CV-CHSims2-MMPareto" \
        ...
        modelname.mmpareto.gamma=${modelname_mmpareto_gamma} \
        modelname.mmpareto.unimodal_loss_weight=${modelname_mmpareto_unimodal_loss_weight}