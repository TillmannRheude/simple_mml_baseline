...
class MOSI_MOSEI(Dataset):
    def __init__(
        ...
        if dataset == "mosi":
            #self.datadir = f"/path/to/data/MOSI/aligned_50_testsplits_split_{split_nr}.pkl"
            self.datadir = f"/path/to/data/archiv/file.pkl"
        elif dataset == "mosei":
            self.datadir = f"/path/to/data/MOSEI/aligned_50_testsplits_split_{split_nr}.pkl"
