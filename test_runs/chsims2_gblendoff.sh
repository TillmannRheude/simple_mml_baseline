...
# modelname.optimizer.lr=3.114579237837494e-05 modelname.optimizer.warmup_steps=500 modelname.optimizer.weight_decay=0.1 modelname.gblend.lookahead_epochs=1 modelname.gblend.mode=offline modelname.gblend.update_freq=5

modelname_optimizer_lr=3.114579237837494e-05
...
python3 /sc-projects/sc-proj-ukb-cvd/projects/simple_mml_baseline_tr/main_incltest.py split_nr=${split_nr} \
        ...
        encoders="ch_sims_v2" \
        modelname=gblend \
        wandb.group="CV-CHSims2-GBLENDOFF" \
