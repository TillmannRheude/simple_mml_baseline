...
To get started quickly, you can download the MOSI dataset with the following script. This dataset is compatible with our MOSI dataloader and is sourced from the IMDer repository.
...
```
Place `file.pkl` in the appropriate data directory for your experiments and change the path in the MOSI dataset class accordingly (`codefiles/datasets/mosi_mosei.py`). 
