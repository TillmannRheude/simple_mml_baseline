...
modelname_optimizer_lr=2.0056902004970352e-05
modelname_optimizer_warmup_steps=500
modelname_optimizer_weight_decay=0.01
modelname_mcr_ceb_reconstruction_head_hidden_dim=256
modelname_mcr_ceb_reconstruction_head_num_layers=3
modelname_mcr_contrastive_temp=0.24138834012920937
modelname_mcr_loss_weights_ceb=0.21474716528312457
modelname_mcr_loss_weights_con=0.17298728156251583
modelname_mcr_loss_weights_mipd=0.13696092448723732
modelname_mcr_loss_weights_uni="[0.2,0.2]"
