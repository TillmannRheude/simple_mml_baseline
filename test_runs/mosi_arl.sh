...
batch_size=128
modelname_optimizer_lr=0.0023871607257753636
modelname_optimizer_warmup_steps=100
modelname_optimizer_weight_decay=0
modelname_arl_temperature=0.4506911693515767
modelname_arl_unimodal_loss_weight=0.9894555162282388
...
python3 /sc-projects/sc-proj-ukb-cvd/projects/simple_mml_baseline_tr/main_incltest.py split_nr=${split_nr} \
        ...
        encoders="mosi" \
        modelname=arl \
        wandb.group="CV-MOSI-SimBaMM-ARL" \
